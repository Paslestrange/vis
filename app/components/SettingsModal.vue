...
<div class="setting-group">
          ...
          <div class="radio-row">
            <label class="radio-option">
              <input type="radio" :checked="themeMode === 'light'" @change="$emit('update:themeMode', 'light')" />
              <span>Light</span>
            </label>
            <label class="radio-option">
              <input type="radio" :checked="themeMode === 'dark'" @change="$emit('update:themeMode', 'dark')" />
              <span>Dark</span>
            </label>
            <label class="radio-option">
              <input type="radio" :checked="themeMode === 'system'" @change="$emit('update:themeMode', 'system')" />
              <span>System</span>
            </label>
          </div>
        </div>
